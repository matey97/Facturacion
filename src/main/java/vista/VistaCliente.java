...
public class VistaCliente implements VistaParaModeloCliente {
    ...
    private ModeloClienteParaVista modeloClienteP;
    private ModeloClienteParaVista modeloClienteE;
    ...
    public void setModeloClienteP(ModeloClienteParaVista modeloCliente) {
        this.modeloClienteP = modeloCliente;
    }

    public void setModeloClienteE(ModeloClienteParaVista modeloCliente) {
        this.modeloClienteE = modeloCliente;
    }

    @Override
    public void nuevoClienteAnyadido() {
        modeloClienteP.getListadoClientes();
    }
